...
export function SolutionSection() {
  return (
    <section id="solutions" className="z-10 bg-white py-12 sm:py-16 md:py-20 lg:py-24">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
        ...
        <div className="flex flex-col min-h-full justify-between order-2 lg:order-1">
          <div>
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl leading-[0.9] sm:leading-[0.9] text-gray-900 tracking-tighter mt-2 font-geist">
              Data labeling built for scale.
            </h2>
            <div className="mt-6 sm:mt-8 relative">
              <div className="flex flex-col gap-4 relative text-gray-600 bg-transparent pr-2 sm:pr-4 pl-2 sm:pl-4">
                {/* Feature 1 */}
                <div className="relative">
                  ...
                  <div className="flex gap-4 items-start">
                    ...
                    <div className="flex-1 pb-4 sm:pb-6">
                      ...
                      <p className="text-xs sm:text-xs text-gray-500 mt-1 font-geist leading-relaxed">50,000+ skilled labelers across 54 countries</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="relative">
                  ...
                  <div className="flex gap-4 items-start">
                    ...
                    <div className="flex-1 pb-4 sm:pb-6">
                      ...
                      <p className="text-xs text-gray-500 mt-1 font-geist leading-relaxed">99.5% accuracy with multi-tier review process</p>
                    </div>
                  </div>
                </div>
        ...
        {/* Image Grid */}
        <div className="grid grid-cols-2 order-1 lg:order-2 relative gap-2 sm:gap-3 md:gap-x-4 md:gap-y-4">
          {/* Card 1 */}
          <article className="group overflow-hidden aspect-[4/3] bg-center transition-transform duration-300 hover:scale-[1.02] bg-[url(/card1.jpg)] bg-cover border-gray-200 rounded-2xl relative shadow-lg">
            ...
            <div className="absolute top-2 left-2 sm:top-3 sm:left-3 transition-transform duration-300 group-hover:scale-110">
              <span className="inline-flex items-center gap-1 sm:gap-2 text-[10px] sm:text-xs text-white/90 bg-white/10 border-white/15 border rounded-full py-1 sm:py-1.5 px-2 sm:px-3 backdrop-blur">Task Management</span>
            </div>
            <div className="absolute bottom-2 left-2 right-2 sm:bottom-3 sm:left-3 sm:right-3 transition-transform duration-300 group-hover:translate-y-[-4px]">
              <p className="text-white text-sm sm:text-base md:text-lg font-medium tracking-tight leading-tight">Data annotation workflows</p>
            </div>
          </article>
          ...
          <article className="group relative overflow-hidden aspect-[4/3] bg-center bg-cover border-gray-200 rounded-2xl bg-[url(/card2.jpg)] transition-transform duration-300 hover:scale-[1.02] shadow-lg">
            ...
            <div className="absolute top-2 left-2 sm:top-3 sm:left-3 transition-transform duration-300 group-hover:scale-110">
              <span className="inline-flex items-center gap-1 sm:gap-2 text-[10px] sm:text-xs text-white/90 bg-white/10 border-white/15 border rounded-full py-1 sm:py-1.5 px-2 sm:px-3 backdrop-blur">AI</span>
            </div>
            <div className="absolute bottom-2 left-2 right-2 sm:bottom-3 sm:left-3 sm:right-3 transition-transform duration-300 group-hover:translate-y-[-4px]">
              <p className="text-white text-sm sm:text-base md:text-lg font-medium tracking-tight leading-tight">Generative AI training</p>
            </div>
          </article>
          ...
          <article className="group relative overflow-hidden aspect-[4/5] bg-center bg-cover border-gray-200 rounded-2xl bg-[url(/card3.jpg)] transition-transform duration-300 hover:scale-[1.02] shadow-lg">
            <div className="absolute inset-0 bg-gradient-to-b from-black/0 via-black/20 to-black/60 transition-opacity duration-300 group-hover:opacity-90"></div>
            <div className="absolute top-2 left-2 sm:top-3 sm:left-3 transition-transform duration-300 group-hover:scale-110">
              <span className="inline-flex items-center gap-1 sm:gap-2 text-[10px] sm:text-xs text-white/90 bg-white/10 border-white/15 border rounded-full py-1 sm:py-1.5 px-2 sm:px-3 backdrop-blur">Healthcare</span>
            </div>
            <div className="absolute bottom-2 left-2 right-2 sm:bottom-3 sm:left-3 sm:right-3 transition-transform duration-300 group-hover:translate-y-[-4px]">
              <p className="text-white text-sm sm:text-base md:text-lg font-medium tracking-tight leading-tight">Medical imaging annotation</p>
            </div>
          </article>
          ...
          <article className="group relative overflow-hidden aspect-[4/5] bg-center bg-cover border-gray-200 rounded-2xl bg-[url(/card4.jpg)] transition-transform duration-300 hover:scale-[1.02] shadow-lg">
            <div className="absolute inset-0 bg-gradient-to-b from-black/0 via-black/20 to-black/60 transition-opacity duration-300 group-hover:opacity-90"></div>
            <div className="absolute top-2 left-2 sm:top-3 sm:left-3 transition-transform duration-300 group-hover:scale-110">
              <span className="inline-flex items-center gap-1 sm:gap-2 text-[10px] sm:text-xs text-white/90 bg-white/10 border-white/15 border rounded-full py-1 sm:py-1.5 px-2 sm:px-3 backdrop-blur">Automation</span>
            </div>
            <div className="absolute bottom-2 left-2 right-2 sm:bottom-3 sm:left-3 sm:right-3 transition-transform duration-300 group-hover:translate-y-[-4px]">
              <p className="text-white text-sm sm:text-base md:text-lg font-medium tracking-tight leading-tight">AI-powered labeling tools</p>
            </div>
          </article>
        </div>
      </div>
