...
export default function Customers() {
  const testimonials = [
    {
      quote: "Labilo transformed our computer vision capabilities. Their understanding of African contexts and multilingual expertise was exactly what our agricultural AI needed.",
    ...
    {
      quote: "Working with Labilo on our fintech models was seamless. Their team understood our compliance requirements and delivered exceptional results.",
      author: "Amara Okafor",
    ...
    {
      quote: "Labilo's government solutions team helped us digitize 50 years of archives with incredible accuracy and cultural sensitivity.",
      author: "Joseph Mbeki",
      ...
      <section className="pt-24 pb-16 px-4">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
            Discover how leading companies across Africa and beyond are using Labilo to accelerate their AI initiatives and achieve remarkable results.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Ready to accelerate your AI initiatives? Join hundreds of companies already achieving remarkable results with Labilo.
          </p>
