...
export default function Government() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16 px-4 bg-muted/30">
        <div className="container mx-auto">
          <h2 className="text-3xl font-light text-center mb-12">Why Governments Choose Datos</h2>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Partner with Datos to accelerate your digital transformation initiatives with secure, compliant, and culturally-aware AI solutions.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/signup">
              <Button size="lg" className="bg-primary">
