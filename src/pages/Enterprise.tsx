...
export default function Enterprise() {
  ...
  const testimonials = [
    {
      quote: "Datos' enterprise solution helped us grow our computer vision models 10x faster than our previous approach.",
      author: "Sarah Chen",
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Join hundreds of enterprise clients who trust Datos with their most important AI initiatives.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/signup">
              <Button size="lg" className="bg-primary">
