  ...
  const codeExamples = [
    {
      ...
      language: "bash",
      code: `curl -X POST https://api.labilo.com/v1/projects \\
  ...
  -d '{
    ...
    },
    {
      ...
      code: `import requests
        ...
        url = "https://api.labilo.com/v1/tasks"
headers = {
      ...
      <section className="pt-24 pb-16 px-4">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
            Integrate Labilo's data labeling services into your applications with our comprehensive REST API.
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                Get up and running with Labilo's API in minutes. Our RESTful API provides 
