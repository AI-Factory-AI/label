...
export default function Documentation() {
  ...
  const codeBlocks = {
    auth: `curl -X POST https://api.labelafrica.com/v1/auth/token \\
  ...
  -d '{
    ...
    createProject: `curl -X POST https://api.labelafrica.com/v1/projects \\
  ...
  -d '{
    ...
    uploadTasks: `curl -X POST https://api.labelafrica.com/v1/projects/proj_123/tasks \\
  -H "Authorization: Bearer YOUR_ACCESS_TOKEN" \\
  -F "file=@wildlife_images.zip" \\
  -F "metadata={\\"batch_size\\": 100, \\"priority\\": \\"high\\"}"`,
    
    getResults: `curl -X GET https://api.labelafrica.com/v1/projects/proj_123/results \\
  -H "Authorization: Bearer YOUR_ACCESS_TOKEN" \\
